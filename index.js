...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {beforeSortArray, afterSortArray, inputVal: val.substring(1,val.length-2), tree}
  }
    ...
    return (
      <div>
        <Row type="flex" style={{width: '2596px', height: '1024px'}}>
          ...
          <Col>
            <div style={{width: '2096px', height: '1024px', border: 'solid 1px black', fontSize: '12px'}}>
              <Tree data={[tree]} nodeSize={ {x: 200, y: 100}} translate={ {x: 50, y: 500}}></Tree>
            </div>
          </Col>
        </Row>
